...
//exit();
  ...
  if($numresults > 0) {
  $result .= '&nbsp;&nbsp;<div style="margin-top: -53px;padding-left: 100px;"><a href="javascript:void(0);" onclick="javascript:parent.PrintResult();">Print this result</a>
  </div><div id="show_results_list">
  <span id="show_search_term" style="display:none;">
  Jurisdiction:<span id="show_jurisdiction_print" style="font-weight: bold;"></span><br>Trigger Item: <span id="show_trigger_print" style="font-weight: bold;"></span><br>Trigger Date <b>: '.$triggerDate.' '.$_POST['txtTime'].'</b><br><span id="show_service_print"></span><br>';
  if($matterString != '') {
        ...
        if ($_POST['cmbMatter'] != "" ) {
            $result .='('.$_POST['cmbMatter'].') ';
             ...
             $result .='</a>';
                ...
                $result .='<ul class="triggersnav">
                    <li>
                        <a href="javascript:void(0);"><span class="court_rule">Court Rule:</span> '.$Event[CalendarRuleEvent][CourtRules][Rule][RuleText];
