...
if ($selectJurisdiction != 0)
{
        ...
        $theTriggers=$array['ArrayOfTriggerItem']['TriggerItem'];
                      ...
                      <select name="cmbTriggers" id="cmbTriggers" style="width:400px;" onchange="get_trigger_service(this.value,<?php echo $selectJurisdiction;?>,'','clear');">
     ...
     <?php if ($selectTriggerItem==$theTriggers[$x]['SystemID']) {
                              ...
                              <?php //echo substr($theTriggers[$x]['Description'],0,65).".";
                               echo $theTriggers[$x]['Description'];
                        ...
                        ?>
                            </select>&nbsp;&nbsp;<span style="padding-left:20px;"><a href="#ex3" rel="modal:open">Get All Triggers</a></span>
                            <?php
                        } else {
