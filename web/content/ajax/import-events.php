...
<div style="width: 100%;clear:both;">
    <div style="float: left;"><h2>View Trigger Event(s)</h2></div>
...
WHERE dc.user_id = ".$_SESSION['userid']." AND dc.case_id = ".$case_id." and e.import_docket_id  = ".$importDocketId." ORDER BY c.import_event_id desc";
        ...
        jQuery.dialogbox({
            ...
            call:[
              function(){
                ...
                window.location.href='http://googledocket.com/docket-case';
             }
            ],
            closeCallback:function(){
                jQuery.dialogbox.prompt({
            ...
            function(){
                ...
                jQuery.ajax({
                    ...
                    success: function (response) {
                       ...
                       setTimeout(function() {
                            window.location.href = 'http://googledocket.com/casetriggers?case_id='+case_id;
                       }, 4000);
                    },
