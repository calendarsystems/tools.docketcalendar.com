...
/*
Description: This script is written to Archive Case and Sub events
Duration : This script is been called from CRON add calendar events 
*/

$msg = 'UPDATE CASE ARCHIVE CRON JOB TIMESTAMP: ';
		$queryUpdateCronJOB = "UPDATE `cronjobrun` set jobrunat = now() where id = 3";
