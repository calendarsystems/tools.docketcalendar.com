...
function genesis_seo_site_description() {
	...
	if ($_SESSION['username']!="")
	{
		...
		<div>
		<img src="../../assets/images/DC_LOGO_RED_WHITE.png" width="72" style="margin-left:10px;" alt="docketcalendar">
		<img src="../../assets/images/TitleONLY.png" width="350" alt="docketcalendar">
		<a href="/procs/logout.php" class="button-102 w-button" style="margin-left:900px;border: 1px solid #FFFFFF;" data-udy-fe="text_-190113873,link_244569889">Logout</a>
		</div>
		<div class="w-form">
	...
	}else
	{
		...
		<img src="../../assets/images/DC_LOGO_RED_WHITE.png" width="72" style="margin-left:10px;" alt="docketcalendar">
		<img src="../../assets/images/TitleONLY.png" width="350" alt="docketcalendar">
		<a href="/login" class="button-102 w-button" style="margin-left:900px;border: 1px solid #FFFFFF;" data-udy-fe="text_-190113873,link_244569889">Login</a>
