...
label.switch-toggle {
    background: url('https://tools.docketcalendar.com/images/switch.png') repeat-y;
...
<div class="widget">
		...
		?>
			<tr>
			   <td style="width:25%"><strong><label class="required">User Name</label>:</strong></td>
				<td>
			...
			<tr>
			   <td style="width:25%"><strong><label class="required">User Email</label>:</strong></td>
			   <td>
			...
			<tr>
			   <td style="width:25%">User Phone No:</td>
			   <td>
	...
	function getGmailContacts()
		...
		function ajaxCallForContactUpdateStatus()
		{
			...
			if (reWhiteSpace.test(userNameContact)) {
				 $.notify("Please provide proper User Name", {
							  type:"danger",
							  align:"center", 
							  verticalAlign:"middle",
							  animation:true,
