...
if ($numresults > 0) {
	if ($numresults > 1) {
        ...
        $result .= '<div style="margin-top: -32px;padding-left: 520px;"><a href="javascript:void(0);" onclick="javascript:PrintResult();">Print this result</a> <a style="padding-left:15px;" href="javascript:void(0);" onclick="javascript:Exlexport();">Excel export</a>
        </div>';
	} else {
        $result .= '<div><h4>RESULTS (' . $numresults . ')</h4></div>';
		$result .= '&nbsp;&nbsp;<div style="margin-top: -52px;padding-left: 180px;margin-bottom: 20px;"><a href="javascript:void(0);" onclick="javascript:parent.PrintResult();">Print this result</a><a style="padding-left:15px;" href="javascript:void(0);" onclick="javascript:Exlexport();">Excel export</a></div>';
	}
