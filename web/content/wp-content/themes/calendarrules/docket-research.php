...
?>
 <h1 class="entry-title" style="float: left;">Docket Research</h1> <div style="float: right;"><a href="https://tools.docketcalendar.com/date-calculator">Date Calculator</a> | <a href="https://tools.docketcalendar.com/docket-calculator">Docket Calculator</a> | Docket Research</div>
 <br clear="all" />
 <?php
