...
$getAllImportDocketIdForCase = "SELECT import_docket_id,calendar_id FROM import_docket_calculator WHERE case_id = ".$_POST['case_id']."";
	...
	$querygetupdateeventsdescInfo = "SELECT eventColor,eventreminderval,eventpopupreminderval FROM updateeventsdesc WHERE importdocketid = '".$importDocketId."' AND caseid = ".$_POST['case_id']." AND eventid IN (0,".$_POST['case_event_id'].")";
