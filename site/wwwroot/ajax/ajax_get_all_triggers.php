...
$row_userInfo = mysqli_affected_rows($userInfo);
...
if ($selectJurisdiction != 0)
{
        ...
        $numTriggers=sizeof($theTriggers);
         if ($numTriggers>0) {
           ...
           echo "<a href='#close-modal' rel='modal:close' class='close-modal'>Close</a>";
           echo "<div style='float:right;'><a href='javascript:void(0);' onclick='javascript:PrintDiv();'>Print this page</a></div>";
           echo "<div id='show_triggers'>";
           echo "<h3>".$_POST['cmbJurisdictions_name']."</h3>&nbsp;";
           foreach($theTriggers as $trigger_value) {
             echo $trigger_value["Description"];
             echo "<br>";
           }
           echo "</div>";
         }
...
<script type='text/javascript'>
    function PrintDiv() {
       var divToPrint = document.getElementById("show_triggers");
