	...
	$userName = $_SESSION['username'];
		...
		elseif($applyjuri == 2)
		{
			$Newapplyjuri = 1;
				...
				if($resultData['duplicateCount'] == 0)
					{
					$insertSQL = "INSERT INTO exclude_events(jurisdiction,trigger_item,events,juriapply,createdBy)  VALUES ('".$cmbJurisdictions."','".$cmbTriggers ."','".$serialize_events."','".$Newapplyjuri."','".$userName."')";
					$result = mysqli_query($docketDataSubscribe,$insertSQL) or trigger_error("Query Failed! SQL: $insertSQL - Error: ".mysqli_error(), E_USER_ERROR);
					if($uncheckevents!='')
					{
						$insert2SQL = "INSERT INTO exclude_events(jurisdiction,trigger_item,events,juriapply,createdBy)  VALUES ('".$cmbJurisdictions."','".$cmbTriggers ."','".$uncheckevents."','".$applyjuri."','".$userName."')";
						$result2 = mysqli_query($docketDataSubscribe,$insert2SQL) or trigger_error("Query Failed! SQL: $insertSQL - Error: ".mysqli_error(), E_USER_ERROR);
					}
