...
//error_reporting(E_ALL);
    ...
    if(isset($_SESSION['docket_search_id'])) {
        ...
        global $attendee;
        $query_case_attendees = "SELECT da.attendee FROM import_docket_calculator ic INNER JOIN docket_cases dc  ON ic.case_id = dc.case_id  INNER JOIN docket_cases_attendees da  ON ic.case_id = da.case_id WHERE import_docket_id = ".$_SESSION['docket_search_id']."  AND dc.created_by = '".$_SESSION['author_id']."'";
