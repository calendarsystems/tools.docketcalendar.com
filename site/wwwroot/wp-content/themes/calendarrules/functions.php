...
<!-- before JS include -->
<script src="https://tools.docketcalendar.com/SpryAssets/SpryValidationCheckbox.js" type="text/javascript"></script>
<script src="https://tools.docketcalendar.com/SpryAssets/SpryValidationTextField.js" type="text/javascript"></script>
<script src="https://tools.docketcalendar.com/SpryAssets/SpryValidationSelect.js" type="text/javascript"></script>
<link href="https://tools.docketcalendar.com/SpryAssets/SpryValidationTextField.css" rel="stylesheet" type="text/css" />
<link href="https://tools.docketcalendar.com/SpryAssets/SpryValidationSelect.css" rel="stylesheet" type="text/css" />
<link href="https://tools.docketcalendar.com/SpryAssets/SpryValidationCheckbox.css" rel="stylesheet" type="text/css" />
<link href="https://tools.docketcalendar.com/jquery/css/ui-lightness/jquery-ui.css" rel="stylesheet" type="text/css" />
...
function custom_footer_creds_text() {
    ...
    echo 'Copyright &copy; ';
    echo date('Y');
    echo ' &middot; <a href="https://tools.docketcalendar.com/">Tools.docketcalendar.com</a>';
    echo '</p></div>';
	*/
}
...
function add_login_logout_link($items, $args) {
    if (@$_SESSION['access_token'] == '') {
        $items .= '
		<li id="menu-item-151" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-has-children menu-item-151"><a href="https://www.google.calendarrules.com/">UTILITIES</a>
			<ul class="sub-menu">
				<li id="menu-item-153" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-153"><a href="/event-option/">Preferences</a></li>
		...
		<li id="menu-item-156" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-has-children menu-item-156"><a href="https://www.google.calendarrules.com/">HELP</a>
			<ul class="sub-menu">
        ...
        if (isset($_SESSION['access_token']) && $_SESSION['account_exist'] == "Y") {
            ...
            $items .= '
			<li id="menu-item-151" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-has-children menu-item-151"><a href="">UTILITIES</a>
			<ul class="sub-menu">
				<li id="menu-item-153" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-153"><a href="/event-option/">Preferences</a></li>
				<li id="menu-item-154" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-154"><a href="/excludevents/">Exclude Events</a></li>
				<li id="menu-item-164" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-164"><a href="/add-custom-contacts/">Contacts</a></li>
				<li id="menu-item-165" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-165"><a target="_blank" href="https://tools.calendarrules.com/rc-googledoc?action=' . $action . '&eml='.$email_encoded.'">Manage Account</a></li>
			</ul>
			</li>
			<li id="menu-item-156" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-has-children menu-item-156"><a href="">HELP</a>
				<ul class="sub-menu">
					<li id="menu-item-157" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-157"><a href="'.$kbcalendarrules_url.'/knowledgebaseui.php?key='.$email_encoded.'&detail='.$user_login_encoded.'&site='.$user_site_encoded."&guideReqVal=goo".'"  target="_blank">User Guide</a></li>
					<li id="menu-item-159" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-159"><a href="'.$kbcalendarrules_url.'/knowledgebaseui.php?key='.$email_encoded.'&detail='.$user_login_encoded.'&site='.$user_site_encoded.'"  target="_blank">Knowledgebase</a></li>
...
function vc_remove_wp_ver_css_js( $src ) {
    if ( strpos( $src, '?_=' . get_bloginfo( 'version' ) ) )
        $src = remove_query_arg( '?_=', $src );
    return $src;
}
