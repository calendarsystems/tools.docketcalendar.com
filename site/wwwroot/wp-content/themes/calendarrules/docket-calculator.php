<?php 
/*
Template Name: Docket Calculator
*/
...
//$_SESSION['author_id'] = "blakefaker48@gmail.com";
 ...
 var jq = jQuery.noConflict();
      ...
      <?php } ?>
		...
		function get_trigger_service(val,val_parent)
		{
			 ...
			 var triggerVal = jQuery("#cmbTriggers").val();
			 ...
			 jQuery("#ajax_trigger_service").html("<img src='https://tools.docketcalendar.com/assets/images/ajax-loader.gif' style='height:30px;'>");
			   jQuery.ajax({
					...
					success: function (response) {
					   jQuery("#cmbTriggers").val(triggerVal);
					   jQuery("#select2-cmbTriggers-container").text(triggerItem);
