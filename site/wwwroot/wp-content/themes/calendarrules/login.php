    ...
    jQuery.ajax({
        ...
        success: function (data, status)
        {
          if(data != "success")
          {
            ...
            var data = '<div style="padding:20px;">Log in to your Google Account to access your Google Calendar with Tools for Calendar Rules.<img src="assets/images/ajax-loader.gif" style="height:30px;"></div>';
            jQuery.dialogbox({
            type:'msg',
            title:'',
            content:data,
