...
<tr class="wpacu_asset_row <?php echo $data['row']['class']; ?>" style="<?php if ($isCoreFile && $hideCoreFiles) { echo 'display: none;'; } ?>">
	<td valign="top">
            ...
            <div class="wpacu_asset_options_wrap">
                ...
                <ul class="wpacu_asset_options">
                    ...
                    if ($data['row']['global_unloaded']) {
                        ...
                        <li>
                            <label><input data-handle="<?php echo $data['row']['obj']->handle; ?>"
                                          class="wpacu_global_unload wpacu_global_script wpacu_unload_rule_input wpacu_unload_rule_for_script"
        ...
        <div class="wpacu_exception_options_area_wrap">
            <p>If unloaded by any of the bulk rules (e.g. everywhere), <strong>make exception</strong> and always:</p>
            <ul class="wpacu_asset_options wpacu_exception_options_area">
                ...
                <li id="wpacu_load_it_regex_option_script_<?php echo $data['row']['obj']->handle; ?>">
                    <label><input data-handle="<?php echo $data['row']['obj']->handle; ?>"
